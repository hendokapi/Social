...
namespace Social.Controllers
{
    public class PostsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PostId,Contents,PostedAt,UserId")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PostId,Contents,PostedAt,UserId")] Post post)
        {
            if (ModelState.IsValid)
            {
